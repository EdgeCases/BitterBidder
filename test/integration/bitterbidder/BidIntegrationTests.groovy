...
class BidIntegrationTests {
    ...
    void test_Bids_WhenMoreThanTenBids_GetLastTenNamedQueryReturnsMostRecentTenBids() {
        ...
        listing.addToBids(new Bid(listing: listing, bidder: bidder, amount: 1.50).save(flush: true))
        listing.addToBids(new Bid(listing: listing, bidder: bidder, amount: 2.50).save(flush: true))
        listing.addToBids(new Bid(listing: listing, bidder: bidder, amount: 3.50).save(flush: true))
        listing.addToBids(new Bid(listing: listing, bidder: bidder, amount: 4.50).save(flush: true))
        listing.addToBids(new Bid(listing: listing, bidder: bidder, amount: 5.50).save(flush: true))
        listing.addToBids(new Bid(listing: listing, bidder: bidder, amount: 6.50).save(flush: true))
        listing.addToBids(new Bid(listing: listing, bidder: bidder, amount: 7.50).save(flush: true))
        listing.addToBids(new Bid(listing: listing, bidder: bidder, amount: 8.50).save(flush: true))
        listing.addToBids(new Bid(listing: listing, bidder: bidder, amount: 9.50).save(flush: true))
        listing.addToBids(new Bid(listing: listing, bidder: bidder, amount: 10.50).save(flush: true))
        listing.addToBids(new Bid(listing: listing, bidder: bidder, amount: 11.50).save(flush: true))
        listing.addToBids(new Bid(listing: listing, bidder: bidder, amount: 12.50).save(flush: true))
