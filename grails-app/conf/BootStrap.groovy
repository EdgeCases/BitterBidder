...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        def listing1 = new Listing(name: "Cars", startingPrice: 1.25, endDateTime: new Date(), description: "Cars the movie", seller: customer1).save(flush: true)
        def listing2 = new Listing(name: "Iphone", startingPrice: 2.25, endDateTime: new Date(), description: "Most overpriced device", seller: customer2).save(flush: true)
        def listing3 = new Listing(name: "cell", startingPrice: 3.25, endDateTime: new Date(), description: "for sale", seller: customer3).save(flush: true)
        def listing4 = new Listing(name: "docs", startingPrice: 4.25, endDateTime: new Date() + 1, description: "ww2 blue prints", seller: customer4).save(flush: true)
        def listing5 = new Listing(name: "shoes", startingPrice: 5.25, endDateTime: new Date() + 2, description: "chuck Ts", seller: customer5).save(flush: true)
        def listing6 = new Listing(name: "food", startingPrice: 6.25, endDateTime: new Date() + 3, description: "Free Soup", seller: customer6).save(flush: true)
        def listing7 = new Listing(name: "Dogs", startingPrice: 7.25, endDateTime: new Date() + 4, description: "chocolate lab", seller: customer7).save(flush: true)
        def listing8 = new Listing(name: "wine", startingPrice: 8.25, endDateTime: new Date() + 5, description: "case of red blends", seller: customer8).save(flush: true)
        def listing9 = new Listing(name: "cigars", startingPrice: 9.25, endDateTime: new Date() + 6, description: "cohibas", seller: customer9).save(flush: true)
        def listing10 = new Listing(name: "wiskey", startingPrice: 10.25, endDateTime: new Date() + 7, description: "Johnny Gold", seller: customer10).save(flush: true)
        def listing11 = new Listing(name: "rum", startingPrice: 11.25, endDateTime: new Date() + 8, description: "Jamaican rum", seller: customer11).save(flush: true)
        def listing12 = new Listing(name: "brews", startingPrice: 12.25, endDateTime: new Date() + 9, description: "Stella Artois!", seller: customer12).save(flush: true)
