...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        def listing1 = new Listing(name: "Listing1", startingPrice: 1.25, endDateTime: new Date() - 1, description: "Description1", seller: customer1).save()
        def listing2 = new Listing(name: "Listing2", startingPrice: 2.25, endDateTime: new Date() - 2, description: "Description2", seller: customer2).save()
        def listing3 = new Listing(name: "Listing3", startingPrice: 3.25, endDateTime: new Date() - 3, description: "Description3", seller: customer3).save()
