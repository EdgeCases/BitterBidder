...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        def listing13 = new Listing(name: "test1", startingPrice: 16.25, endDateTime: new Date() + 10, description: "Description 1", seller: customer1, wasNotificationSent: false).save(flush: true)
        def listing14 = new Listing(name: "test2", startingPrice: 17.25, endDateTime: new Date() + 11, description: "Description 2", seller: customer1, wasNotificationSent: false).save(flush: true)
        def listing15 = new Listing(name: "test3", startingPrice: 18.25, endDateTime: new Date() + 12, description: "Description 3", seller: customer1, wasNotificationSent: false).save(flush: true)
