...
<html>
	...
	<body>
		<a href="#create-bid" class="skip" tabindex="-1">
...
%{--
            <g:if test="${bidInstance.listing}">
                <label>Last Bid Amount</label>
                <label>${bidInstance.listing.latestBid?.amount.encodeAsHTML()}</label>
                <label>${bidInstance.listing.latestBid}</label>
            </g:if>
--}%
			<g:form action="save" >
				<fieldset class="form">
